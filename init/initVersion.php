...
if (! $dbLayoutVerification) {
    ...
    echo "<a href='../../tfyh/pages/databaseAudit.php'><input type='submit' class='formButton' value='" .
        $i18n->t("oCZhmi|start audit") . "'></a></p>";
} else {
    echo $i18n->t("5kpp1Q|Version %1 is no ready t...", file_get_contents("../../version"));
    echo "<br>" . $i18n->t("88nTjP|Please do not reload thi...") . "<br><br>";
    $appName = Config::getInstance()->appName;
    echo "<a href='../$appName/pages/home.php'><input type='submit' class='formButton' value='" .
